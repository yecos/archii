...
export const NAV_ITEMS = [
  ...
  { id: 'inspections', icon: '🔍', label: 'Inspecciones' },
  ...
  { id: 'fieldNotes', icon: '📝', label: 'Minutas de Obra' },
  ...
  { id: 'purchaseOrders', icon: '🛒', label: 'Órdenes de Compra' },
  { id: 'calendar', icon: '📅', label: 'Calendario' },
  { id: 'gantt', icon: '📊', label: 'Cronograma' },
  { id: 'portal', label: 'Portal Cliente', icon: '🤝' },
  { id: 'gallery', icon: '📸', label: 'Galería' },
  { id: 'photoLog', icon: '📷', label: 'Bitácora Fotográfica' },
  { id: 'inventory', icon: '📦', label: 'Inventario' },
  { id: 'reports', icon: '📈', label: 'Reportes' },
  { id: 'templates', icon: '📐', label: 'Templates de Proyecto' },
  { id: 'reportGenerator', icon: '✨', label: 'Generador Reportes' },
...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'reportGenerator', label: 'Generador PDF', icon: '✨' },
