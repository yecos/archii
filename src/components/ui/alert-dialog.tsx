...
function AlertDialogAction({
  ...
  return (
    <AlertDialogPrimitive.Action
      className={cn(buttonVariants(), "shadow-[var(--skeuo-shadow-btn)] hover:shadow-[var(--skeuo-shadow-raised-lg)] active:shadow-[var(--skeuo-shadow-btn-active)] active:translate-y-[1px]", className)}
      {...props}
    />
  )
}
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Cancel
      className={cn(buttonVariants({ variant: "outline" }), "bg-[var(--skeuo-raised)] border border-[var(--skeuo-edge-light)] shadow-[var(--skeuo-shadow-raised-sm)]", className)}
      {...props}
    />
  )
}
