...
export default function InvReportsTab({
  invProducts, invCategories, invMovements, invTransfers, invTotalStock, invTotalValue,
  getTotalStock, getWarehouseStock, getInvCategoryColor, getInvCategoryName, getInvProductName,
  showToast,
}: InvReportsTabProps) {
  return (
