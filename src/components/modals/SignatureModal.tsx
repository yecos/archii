...
export default function SignatureModal({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 animate-fadeIn" onClick={handleClose}>
      {/* Backdrop */}
      <div className="absolute inset-0 bg-black/50 backdrop-blur-sm" />

      {/* Modal */}
      <div
        className="relative w-full max-w-lg card-elevated rounded-2xl p-5 shadow-2xl animate-scaleIn"
      ...
      >
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-[14px] font-semibold">Firma Electronica</div>
