    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-gradient-to-br from-[var(--background)] via-[var(--af-bg3)] to-[var(--background)]">
      <div className="relative overflow-hidden card-glass rounded-2xl p-8 w-full max-w-[400px] shadow-xl border border-[var(--input)]">
        ...
        {!forms.showRegister ? (<>
          ...
          <button
            className={`w-full bg-gradient-to-r from-[var(--af-accent)] to-[var(--af-accent2)] text-background border-none rounded-lg py-3 text-sm font-semibold transition-all duration-200 ${hasLoginErrors || authLoading || fbStatus.status !== 'ok' ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer hover:shadow-[0_4px_15px_rgba(158,124,62,0.3)] hover:scale-[1.02]'}`}
          ...
          <button className="w-full bg-[var(--af-bg3)] border border-[var(--input)] rounded-lg py-2.5 text-sm font-medium text-[var(--foreground)] cursor-pointer hover:bg-[var(--af-bg4)] hover:-translate-y-0.5 hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2.5 mt-2 disabled:opacity-50 disabled:cursor-not-allowed" onClick={handleMicrosoftClick} disabled={authLoading || fbStatus.status !== 'ok'}>
          ...
          <button
            className={`w-full bg-gradient-to-r from-[var(--af-accent)] to-[var(--af-accent2)] text-background border-none rounded-lg py-3 text-sm font-semibold transition-all duration-200 ${hasRegisterErrors || authLoading || fbStatus.status !== 'ok' ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer hover:shadow-[0_4px_15px_rgba(158,124,62,0.3)] hover:scale-[1.02]'}`}
